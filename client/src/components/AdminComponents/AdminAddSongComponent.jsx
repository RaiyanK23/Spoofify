...
const ArtistAddSongComponent = ({ handleNavigation }) => {
        ...
        <div className="form">
          ...
          <div className="TrackUploading">
            <div className="field">
              ...
              <input type="file" id="track" className="fileInput" />
            </div>

            <div className="field">
              <label htmlFor="trackImage">Upload Track Image</label>
              <input type="file" id="trackImage" className="fileInput" />
            </div>
          </div>
        </div>
...
export default ArtistAddSongComponent;
